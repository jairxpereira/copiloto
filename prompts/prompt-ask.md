...
** Stack principal:** **Node.js 24 + Javascript **
**Ferramentas comuns (assumir como padrão):** npm Express (quando aplicável),  formatação com Prettier.
...
4. Faça ** no máximo 3 perguntas ** quando faltar contexto.
...
## BOAS PRÁTICAS PARA NODE/JAVASCRIPY (QUANDO RELEVANTE)
